...
public class ChessDb {
    ...
    /**
     * constructor that adds two games to the collection
     */
    public ChessDb() {
        games = new ArrayList<>();
    ...
    /**
     * creates the Morphy - Isouard game
     * @return a ChessGame representing that
     */
    private ChessGame morphyIsouard() {
        ...
        game.addMove("Rd8#");
        game.setFinalPosition(new ArrayList<>(Arrays.asList("1n1Rkb1r",
            "p1111ppp", "1111q111", "1111p1B1", "1111P111", "11111111",
            "PPP11PPP", "11K11111")));
        return game;
    }
    /**
     * creates the Tal - Fischer game
     * @return that game
     */
    private ChessGame talFischer() {
        ...
        game.setFinalPosition(new ArrayList<>(Arrays.asList("1rb1RR11",
            "11p1n1k1", "p1111111", "1p1PN11p", "1p11111P", "11111111",
            "P11111P1", "111111K1")));
        return game;
